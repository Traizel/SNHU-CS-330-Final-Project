...
void SceneManager::DefineObjectMaterials()
{
	...
	floorMaterial.diffuseColor = glm::vec3(0.95f, 0.86f, 0.90f);
	...
	OBJECT_MATERIAL supportMaterial;
	supportMaterial.diffuseColor = glm::vec3(0.48f, 0.48f, 0.52f);
	supportMaterial.specularColor = glm::vec3(0.22f, 0.22f, 0.22f);
	supportMaterial.shininess = 18.0f;
	supportMaterial.tag = "support";
	m_objectMaterials.push_back(supportMaterial);

	OBJECT_MATERIAL beamMaterial;
	beamMaterial.diffuseColor = glm::vec3(0.72f, 0.60f, 0.66f);
	beamMaterial.specularColor = glm::vec3(0.18f, 0.18f, 0.18f);
	beamMaterial.shininess = 12.0f;
	beamMaterial.tag = "beam";
	m_objectMaterials.push_back(beamMaterial);

	OBJECT_MATERIAL objectMaterial;
	objectMaterial.diffuseColor = glm::vec3(0.55f, 0.42f, 0.48f);
	objectMaterial.specularColor = glm::vec3(0.35f, 0.35f, 0.35f);
	objectMaterial.shininess = 24.0f;
	objectMaterial.tag = "object";
	m_objectMaterials.push_back(objectMaterial);

	OBJECT_MATERIAL coneMaterial;
	coneMaterial.diffuseColor = glm::vec3(0.82f, 0.72f, 0.78f);
	coneMaterial.specularColor = glm::vec3(0.20f, 0.20f, 0.20f);
	coneMaterial.shininess = 14.0f;
...
void SceneManager::SetupSceneLights()
{
	...
	// Key light: full strength with a slightly green tint.
	m_pShaderManager->setVec3Value("lightSources[0].position", -6.0f, 8.0f, 6.0f);
	m_pShaderManager->setVec3Value("lightSources[0].ambientColor", 0.05f, 0.08f, 0.05f);
	m_pShaderManager->setVec3Value("lightSources[0].diffuseColor", 0.70f, 1.00f, 0.70f);
	m_pShaderManager->setVec3Value("lightSources[0].specularColor", 0.35f, 0.50f, 0.35f);
	...
	// Fill light: much softer white light from the opposite side.
	...
	m_pShaderManager->setVec3Value("lightSources[1].diffuseColor", 0.10f, 0.10f, 0.10f);
...
void SceneManager::RenderScene()
{
	...
	// disable texture usage for this assignment scene
	m_pShaderManager->setBoolValue(g_UseTextureName, false);

	// set the object material and base color values in the shader
	SetShaderMaterial("floor");
	SetShaderColor(0.97f, 0.88f, 0.92f, 1.0f);
	...
	SetShaderColor(0.74f, 0.63f, 0.69f, 1.0f);
	...
	SetShaderColor(0.58f, 0.46f, 0.52f, 1.0f);
	...
	SetShaderColor(0.86f, 0.76f, 0.81f, 1.0f);

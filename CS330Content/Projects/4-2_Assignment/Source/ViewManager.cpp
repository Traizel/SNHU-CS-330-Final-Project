...
GLFWwindow* ViewManager::CreateDisplayWindow(const char* windowTitle)
{
	...
	// this callback is used to receive mouse wheel scroll events
	glfwSetScrollCallback(window, &ViewManager::Mouse_Scroll_Callback);

	// tell GLFW to capture all mouse events so the camera can orbit smoothly
 ...
 *
 *  This method is automatically called from GLFW whenever
 *  the mouse wheel is scrolled within the active display
 *  window. It adjusts the camera travel speed.
 ***********************************************************/
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	// process camera movement upward and downward

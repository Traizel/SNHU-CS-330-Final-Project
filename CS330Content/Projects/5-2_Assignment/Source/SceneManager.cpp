...
void SceneManager::LoadSceneTextures()
{
	...
	// Texture 1: tile pattern for the large ground plane.
	bReturn = CreateGLTexture(
		"../../Utilities/textures/tilesf2.jpg",
		"floor");

	// Texture 2: wood grain for the long balance beam.
	bReturn = CreateGLTexture(
		"../../Utilities/textures/rusticwood.jpg",
		"wood");

	// Texture 3: abstract pattern for the cone.
	bReturn = CreateGLTexture(
		"../../Utilities/textures/abstract.jpg",
		"abstract");

	// Prevent an unused-variable warning in some compiler settings.
	if (!bReturn)
	{
...
void SceneManager::RenderScene()
{
	...
	// Apply a repeating tile texture to the ground plane.
	...
	// Apply a wood texture to the cylinder support piece.
	...
	// Map a wood texture to the long beam.
	SetShaderTexture("wood");
	...
	// Apply the floor texture to the small box support.
	SetShaderTexture("floor");
	SetTextureUVScale(1.0f, 1.0f);
	...
	// Apply the abstract texture to the sphere at the top of the scene.
	...
	// Apply a second unique texture to the cone.
	SetShaderTexture("abstract");
	SetTextureUVScale(1.0f, 1.0f);
